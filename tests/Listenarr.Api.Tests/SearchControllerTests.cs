...
namespace Listenarr.Api.Tests
{
    public class SearchControllerTests
    {
        ...
        public async Task IntelligentSearch_ReturnsEnrichedResults()
        {
            ...
            mockService.Setup(s => s.IntelligentSearchAsync(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<double>(), It.IsAny<System.Threading.CancellationToken>())).ReturnsAsync(sample);
